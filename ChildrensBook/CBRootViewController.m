...
- (CBModelController *)modelController
{
...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray *)previousViewControllers transitionCompleted:(BOOL)completed
{
    if (completed){
     ...
     UIViewController *currentViewController = [pageViewController.viewControllers lastObject];
        NSLog(@"Index of current page: %d", [self.modelController indexOfViewController:currentViewController]);
        _currentPageIndex = [self.modelController indexOfViewController:currentViewController];
    }
...
- (UIPageViewControllerSpineLocation)pageViewController:(UIPageViewController *)pageViewController spineLocationForInterfaceOrientation:(UIInterfaceOrientation)orientation
{
    ...
    CBDataViewController *currentViewController = self.pageViewController.viewControllers[0];
